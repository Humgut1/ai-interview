    ...
    >
      <header className="flex items-center gap-2 border-b border-slate-100 px-4 py-3">
        <button
          ...
          className="cursor-grab rounded-md px-1.5 py-1 text-slate-400 hover:bg-slate-100 hover:text-slate-600 active:cursor-grabbing"
        >
          ⠿
        </button>
        ...
        <span className="text-xs text-slate-500">전체의 {percent}%</span>
        ...
        <div className="ml-auto flex items-center gap-1">
          <button
            ...
            disabled={index === 0}
            aria-label="위로 이동"
            className="rounded-md px-2 py-1 text-sm text-slate-500 hover:bg-slate-100 disabled:opacity-30 disabled:hover:bg-transparent"
          >
            ↑
          </button>
          <button
          ...
          <button
            type="button"
            onClick={onRemove}
            className="rounded-md px-2 py-1 text-sm text-slate-500 hover:bg-rose-50 hover:text-rose-600"
          >
            삭제
          </button>
        </div>
      ...
      <div className="flex flex-col gap-5 px-4 py-4">
        ...
        <div className="flex flex-col gap-3">
          <div className="flex flex-wrap items-baseline gap-2">
            <h3 className="text-sm font-medium text-slate-800">평가 기준</h3>
          ...
          >
            <div className="flex items-center gap-2">
              <button
                ...
                className="h-9 w-9 rounded-lg border border-slate-300 text-slate-600 hover:bg-slate-50 disabled:opacity-30"
              >
                −
              </button>
              ...
              {followUpOptions.map((count) => {
                ...
                return (
                  <button
                    ...
                    className={[
                      "h-9 w-10 rounded-lg border text-sm transition",
                      selected
